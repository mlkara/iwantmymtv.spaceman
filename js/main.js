...
const categories = {
  ...
  nineties: ['red hot chili peppers', 'pearl jam', 'nirvana', 'rem', 'tlc', 'no doubt', 'beck', 'green day', 'the cranberries', 'goo goo dolls', 'smashing pumpkins', 'alice in chains', 'hole','radiohead', 'garbage', 'smash mouth', 'paul van dyk', 'beastie boys', 'alanis morrisette', 'the rembrandts'],
...
const hints = {
  ...
  mixTape: ['In 1969, this band wrote one of the first rock operas: Arthur, or the Decline and Fall of the British Empire. It was released the same year as the more successful Tommy by the Who, so many have forgotten about it. You really got me.', 'Their self-titled album was recorded in six days from start to finish. They broke on through the other side.', 'This french due spent four million of their own money to create their animated film.I feel it coming', 'British electronic duo composed of Imogen Heap and Guy Sigsworth'],
};
